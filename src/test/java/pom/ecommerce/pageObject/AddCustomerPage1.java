...
public class AddCustomerPage1 {
     ...
     public void  AddCustomerPage(WebDriver rdriver) {
    	 idriver=rdriver;
    	 PageFactory.initElements(rdriver, this);
     }
     @FindBy(how=How.XPATH,using="/html/body/div[3/div/ul/li[2]/a")
     WebElement linkAddNewCustomers;
     ...
     //For every above elements we are going to write Action Method
     
     public void clickAddNewCustomer() {
    	 linkAddNewCustomers.click();
     }
